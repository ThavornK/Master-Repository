...
install_xcframework "${PODS_ROOT}/AmityUIKit/Distribution/AmityUIKit.xcframework" "AmityUIKit" "framework" "ios-x86_64-simulator" "ios-arm64"
install_xcframework "${PODS_ROOT}/AmityUIKit/Distribution/AmitySDK.xcframework" "AmitySDK" "framework" "ios-x86_64-simulator" "ios-arm64"
install_xcframework "${PODS_ROOT}/AmityUIKit/Distribution/Realm.xcframework" "Realm" "framework" "ios-i386_x86_64-simulator" "ios-arm64_armv7"
